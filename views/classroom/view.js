  ...
  if (user.role === 'teacher') {
    ...
    actionsButtons = `
      <div class="mt-3 d-flex justify-content-end">
        ...
        <button class="btn btn-sm btn-danger ml-3" onclick="closeClassroom('${group}');">${locale.buttons.end_onelinelesson[config.lang]}</button>
      </div>
    `;
  } else {
    actionsButtons = `
    <div class="mt-3 d-flex justify-content-end">
      ...
      <button class="btn btn-danger ml-3" onclick="exitClassroom();">
        Exit
      </button>
    </div>
    `;
