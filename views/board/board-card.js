      ...
      returnHtml += `
        <div class="border mt-2 bg-light board-card">
          <div class="py-2 px-3 h-100 w-100 d-flex justify-content-between ${topicColor}">
            ...
            ${myTopic.autofill === true && role === 'student' ? getIcon(card.lessonType) : ''}
...
function getIcon (lessonType) {
  if (lessonType === 'onlinelesson') {
    return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="24" fill="currentColor" class="bi bi-camera-video" viewBox="0 0 16 16">
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="24" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
