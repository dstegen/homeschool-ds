...
function getIcon (lessonType, camColor='currentColor', iconSize='16') {
  if (lessonType === 'onlinelesson') {
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${iconSize}" height="${iconSize}" fill="${camColor}" class="bi bi-camera-video mr-1 mb-1" viewBox="0 0 16 16">
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${iconSize}" height="${iconSize}" fill="currentColor" class="bi bi-book mr-1 mb-1" viewBox="0 0 16 16">
