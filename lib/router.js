...
const { webView, login, logout, editAction, updateAction, deleteAction, fileUploadAction, fileDeleteAction, finishLessonAction, updateChatAction, updatePrivateMessagesAction, updateUserAction, setPasswordAction, updatePasswordAction, editUserAction, settingsAction, updateBoard } = require('./controller');
...
function router (request, response, wss, wsport) {
 ...
 } else if (request.url.includes('board') && request.url.includes('update')) {
   updateBoard(request, response);
 } else if (request.url.includes('board') && request.url.includes('delete')) {
   updateBoard(request, response);
 } else {
