...
function formatDateWithDay (weekday=1, week=thisWeek()) {
  return moment().day(weekday).week(week).format('dddd[, ] DD. MMM YYYY'); //String
}
...
module.exports = { thisWeek, thisDay, weekDates, weekDayNumber, formatDay, formatDate, weekDay, beforeToday, isActualWeek, momentFromDay, workdaysBetween, dateIsRecent, beforeFinishDate, notValid, getDaytime, dayFromWeek, weeksArray, formatDateWithDay, validFromUntil, getWebDate, weekDayFromNumber };
